...
public class CategoriaDAO extends Categoria implements DAO{
	...
	public CategoriaDAO(String id, String descricao, String acronimo) throws Exception{
	...
	public CategoriaDAO(String descricao) throws Exception{
		super(descricao);
	}

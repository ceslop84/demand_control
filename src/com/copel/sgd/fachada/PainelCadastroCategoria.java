...
public class PainelCadastroCategoria extends JPanel {

	/**
	 * 
	 */
	private static final long serialVersionUID = 623591593938169746L;
	...
	public PainelCadastroCategoria() {	
		super();
		
		BarraDeNotificacoes.atualizar("Cadastro de categoria.");
		...
		try {
			cbDescricao.carregar(Ferramentas.deClasseParaArray(categoriaBo.carregarTodos()));
		} catch (Exception e) {
		...
		btnConsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					categoriaBo.carregar(cbDescricao);
					Funcoes.atualizarCampos(listaDeCampos, categoriaBo.toArray() );
				} catch (Exception e) {
					BarraDeNotificacoes.atualizar(e);
				}
			}
		...
		btnRemover.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {	
					...
					BarraDeNotificacoes.atualizar(categoriaBo.remover(textId));
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {	
					new CaixaDeMensagem().confirmarAcao();
					BarraDeNotificacoes.atualizar(categoriaBo.salvar(listaDeCampos));
					Funcoes.atualizarCampos(listaDeCampos, null);
				} catch (Exception e) {
					BarraDeNotificacoes.atualizar(e);
				}  
		...
		cbDescricao.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					cbDescricao.recarregar(Ferramentas.deClasseParaArray(categoriaBo.carregarTodos()));
				} catch (Exception e) {
					BarraDeNotificacoes.atualizar(e);
				}	
			}
